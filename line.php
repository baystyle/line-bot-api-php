  ...
  if ( $event['type'] == 'message' ) 
  {
   ...
   if( $event['message']['type'] == 'text' )
   {
		...
		if(($text == "อยากทราบยอด COVID-19 ครับ")||($text == "อยากทราบยอด COVID-19")||($text == "COVID-19")){
			$m1 = "รายงานสถานการณ์ ยอดผู้ติดเชื้อไวรัสโคโรนา 2019 (COVID-19) ในประเทศไทย <br>";
			$m2 = "ผู้ป่วยสะสม	จำนวน 398,995 ราย <br>";
			$m3 = "ผู้เสียชีวิต	จำนวน 17,365 ราย <br>";
			$m4 = "รักษาหาย	จำนวน 103,753 ราย <br>";
			...
			$reply_message = 'ขณะนี้อยู่ที่ห้องเรียน IF-5T05 eiei';
		}
		else
		{
